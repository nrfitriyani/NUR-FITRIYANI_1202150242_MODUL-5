...
public class Database extends SQLiteOpenHelper {
    //mendeklarasi variabel yang akan digunakan
    Context cntx;
    SQLiteDatabase db;
    ...
    //method untuk menghapus list data pada database
    public boolean removedata(String ToDo) {
        return db.delete(nama_tabel, kolom_1+"=\""+ToDo+"\"", null)>0;
    }

    //method untuk akses dan membaca data dari database
