...
public class Adapter extends RecyclerView.Adapter<Adapter.holder> {
    ...
    //menentukan viewholder sebagai fungsi recyclerview
    @Override
    ...
    //mengatur value yang didapatkan pada viewholder
    @Override
    ...
    //mendapatkan jumlah list to do
    @Override
    public int getItemCount() {
        return list.size();
    }

    //mendapatkan list yang terdapat dari adapter
    public AddData getData(int position){
        return list.get(position);
    }

    //untuk menghapus list yang diinputkan pada todolist
    ...
    class holder extends RecyclerView.ViewHolder{
        //mendeklarasi kan variable yang akan digunakan
